    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3" style="margin-top:3rem;margin-bottom:3rem">
        <div class="col">
            <div class="card shadow-sm" style="border:transparent">
                <a href="/partnership"><img class="card-img-top" width="100%" height="100%" src="assets/images/imgnews.jpg" alt="Card image cap" focusable="false"></a>
        ...
        <div class="col">
            <div class="card shadow-sm" style="border:transparent">
                <a href="/partnership"><img class="card-img-top" width="100%" height="100%" src="assets/images/leader.jpg" alt="Card image cap" focusable="false"></a>
                <div class="card-body" style="background-color: #ececec">
        ...
        <div class="col">
            <div class="card shadow-sm" style="border:transparent">
                <a href="/partnership"><img class="card-img-top" width="100%" height="100%" src="assets/images/salary.jpg" alt="Card image cap" focusable="false"></a>
                <div class="card-body" style="background-color: #ececec">
