        ...
        <div class="col-sm-12" style="margin-bottom:0px; margin-top:3rem">
            ...
            <div class="row">
                <div class="col-sm-5" style="margin-top:50px;margin-bottom:100px;background-color:#ececec">
                    ...
                    <p style="font-size:12pt;margin-right:0px;padding:15px 15px 15px 15px;">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. In in neque venenatis, tincidunt libero et, porta lectus.
                        ...
                        <span id="dots">...</span><span id="more"> Vivamus luctus velit erat, at placerat magna dictum sed. Interdum et malesuada fames ac ante ipsum primis in faucibus. Quisque lacinia quam vel sapien lobortis, sit amet vehicula lectus ultricies.</span>
                    </p>
                    <button type="button" class="btn btn-primary btn-modal">Read More</button>
