...
<div class="container">
    <div class="row">
        <div class="col-sm-12" style="margin-bottom:3rem; margin-top:3rem">
            ...
            <h6 style="font-weight: bold; font-style: italic; color:grey;margin-bottom: 1rem;margin-bottom: 0px; ">20/01/2023</h6>
            <img src="assets/images/news.jpg" style="height:fit-content; width: 100%;margin-top: 1rem; ">
        </div>
    </div>
</div>
